...
class SquatView:
    ...
    def __init__(self, root, press_login, press_squat_data):
        ...
        Args:
            ...
            press_squat_data:
                Kutsuttava arvo, jolla siirrytään kyykky-tulosten katselunäkymään.
        """
        self._root = root
        self._frame = None
    ...
    def _initialize(self):
        ...
        squat_text = tk.Label(master=self._frame,
                              text="New squat", font=("Arial", 14, "bold"))
        ...
        squat_data_button = tk.Button(
            master=self._frame, text="PAST RESULTS", command=self._press_squat_data)
    ...
    def _write_to_file(self):
        """Kirjoittaa käyttäjän kirjoittaman tuloksen ylös squat.csv tiedostoon."""

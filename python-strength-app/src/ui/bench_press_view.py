...
class BenchPressView:
    ...
    def __init__(self, root, press_login, press_bench_press_data):
        ...
        Args:
            ...
            press_bench_press_data:
                Kutsuttava arvo, jolla siirrytään penkkipunnerrus-tulosten katselunäkymään.
        """
        self._root = root
        self._frame = None
    ...
    def _write_to_file(self):
        """Kirjoittaa käyttäjän kirjoittaman tuloksen ylös bench_press.csv tiedostoon."""

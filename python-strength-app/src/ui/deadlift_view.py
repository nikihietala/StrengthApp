...
class DeadliftView:
    def __init__(self, root, press_login, press_deadlift_data):
        ...
        self._press_deadlift_data = press_deadlift_data
    ...
    def _initialize(self):
        ...
        deadlift_data_button = tk.Button(
            master=self._frame, text="PAST RESULTS", command=self._press_deadlift_data)
        deadlift_data_button.pack(pady=10)
    ...
    def _write_to_file(self):
        ...
        if confirmation == 'yes':
            ...
            if not re.fullmatch(allowed, self._rep_entry.get()):
                ...
                return
            with open(self._deadlift_file_path, "a", newline='') as file:
                Writer = writer(file)

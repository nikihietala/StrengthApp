...
class ExerciseRepository:
    ...
    def read_squat(self):
        ...
        with open(self._squat_file_path, "r", newline="", encoding="utf-8") as data:
    ...
    def read_deadlift(self):
        ...
        with open(self._deadlift_file_path, "r", newline="", encoding="utf-8") as data:
            read_data = reader(data)
            data = list(read_data)
            for item in data[1:]:
                if item[3] == f"{self._user.username}":
    ...
    def read_bench_press(self):
        ...
        with open(self._bench_press_file_path, "r", newline="", encoding="utf-8") as data:
            read_data = reader(data)
            data = list(read_data)
            for item in data[1:]:
                if item[3] == f"{self._user.username}":
    ...
    def read_shoulder_press(self):
        ...
        with open(self._shoulder_press_file_path, "r", newline="", encoding="utf-8") as data:
            read_data = reader(data)
            data = list(read_data)
            for item in data[1:]:
                if item[3] == f"{self._user.username}":
    ...
    def read_pull_up(self):
        ...
        with open(self._pull_up_file_path, "r", newline="", encoding="utf-8") as data:
            read_data = reader(data)
            data = list(read_data)
            for item in data[1:]:
                if item[3] == f"{self._user.username}":
